...
import { Globe, ArrowLeft, Loader2, User, Mail, Lock, Sparkles, ShieldCheck } from "lucide-react"
...
export default function SignupPage() {
    ...
    return (
        <div className="min-h-screen w-full flex flex-col items-center justify-center relative overflow-hidden bg-[#020111]">
            {/* Animated Background Elements */}
            <div className="absolute inset-0 z-0 text-white">
                <div className="absolute top-[20%] right-[-10%] w-[40%] h-[40%] bg-emerald-600/10 rounded-full blur-[120px] animate-pulse" />
                <div className="absolute bottom-[20%] left-[-10%] w-[40%] h-[40%] bg-teal-600/10 rounded-full blur-[120px] animate-pulse" />
            ...
            >
                ...
                <div className="flex flex-col items-center text-center space-y-3 mb-8">
                    ...
                    <h1 className="text-3xl font-bold tracking-tight text-white uppercase tracking-[0.2em] text-sm opacity-50">Join the Tribe</h1>
                    <h2 className="text-4xl font-black text-foreground">Explorer <span className="text-emerald-500">Register</span></h2>
                </div>
                ...
                <Card className="glass-panel border-white/5 shadow-2xl overflow-hidden rounded-[2rem]">
                    ...
                    <CardHeader className="pt-8 text-center">
                        <CardTitle className="text-2xl font-bold">Create Membership</CardTitle>
                        <CardDescription className="text-muted-foreground/60 italic">
                            Begin your AI-guided nature exploration today
                        </CardDescription>
                    </CardHeader>
                    <form onSubmit={handleSubmit}>
                        ...
                        <CardFooter className="flex flex-col space-y-6 pb-8 px-8">
                            <Button
                                type="submit"
                                className="w-full h-14 bg-gradient-to-r from-emerald-600 to-teal-700 text-white hover:shadow-[0_0_30px_rgba(16,185,129,0.4)] transition-all rounded-2xl font-black uppercase tracking-widest text-sm relative overflow-hidden group mt-4"
                                disabled={isLoading}
                            >
                            ...
                            <div className="text-center text-sm text-muted-foreground">
                                Already an explorer?{" "}
                                <Link href="/login" className="text-emerald-500 hover:text-emerald-400 font-black transition-colors">
                                    Sign In
                                </Link>
                            </div>
                        </CardFooter>
