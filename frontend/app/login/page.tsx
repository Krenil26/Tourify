                ...
                <Card className="border-border/50 shadow-xl">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <CardFooter className="flex flex-col space-y-4">
                            <Button
                                type="submit"
                                className="w-full h-12 bg-gradient-to-r from-emerald-500 to-teal-600 text-white hover:opacity-90 shadow-lg shadow-emerald-500/20 rounded-xl font-bold uppercase tracking-wider transition-all hover:scale-[1.02]"
                                disabled={isLoading}
                            >
                                {isLoading ? (
                                    <>
                            ...
                            <p className="text-[10px] text-muted-foreground text-center px-4 leading-tight opacity-60">
                                Note: Logins may take up to 50 seconds if the free-tier backend is waking up from sleep.
                            </p>

                            <div className="text-center text-sm text-muted-foreground pt-2">
                                New to Tourify?{" "}
                                <Link href="/signup" className="text-emerald-500 hover:text-emerald-400 hover:underline font-bold">
                                    Create account
                                </Link>
                            </div>
                        </CardFooter>
